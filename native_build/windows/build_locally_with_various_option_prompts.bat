...
.\cygwin_local_install\bin\bash.exe -c "wget https://raw.github.com/harry159821/ffmpeg-windows-build-helpers/master/cross_compile_ffmpeg.sh -O cross_compile_ffmpeg.sh"
